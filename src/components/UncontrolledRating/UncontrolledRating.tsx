...
export const UncontrolledRating = React.memo((props: UncontrolledRatingPropsType) => {
...
const Star = React.memo(UncontrolledStarWithoutMemo)

function UncontrolledStarWithoutMemo(props: StarPropsType) {
